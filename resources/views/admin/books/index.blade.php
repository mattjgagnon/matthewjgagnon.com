...
@section('content')
    ...
    <a href="{{ route('admin.books.create') }}" class="btn-primary text-contrast px-4 py-2 rounded-lg">+ Add Book</a>
    ...
    <table class="w-full bg-gray-800 text-contrast rounded-lg mt-6">
        <thead>
